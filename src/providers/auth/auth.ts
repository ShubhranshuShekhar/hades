...
export class AuthProvider {
  // We are setting property on this service - user - this is overserbale
  user: Observable<any>;
  ...
  //// EMAIL ////
  async emailLogin(useremail:string, userpassword:string): Promise<void> {
    let myuser: any;
    ...
    const user = await this.afAuth.auth.signInWithEmailAndPassword(useremail, userpassword);
    await this.updateUserData(user);
  }
